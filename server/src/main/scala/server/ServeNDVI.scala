...
/** Starting the satellite geongine server
*
**/
object ServeNDVI {
  ...
  def main(args: Array[String]): Unit = {
    ...
    implicit val system = akka.actor.ActorSystem("server")
    ...
    val service = system.actorOf(Props(classOf[NDVIServiceActor]), "server")
...
trait MyService extends HttpService {
  ...
  /* Return the tile raster data in PNG format for Leaflet.js*/
  ...
  /* Calculate the sum of the operation metric parameter (e.g. average NDVI) */
  def sum =
