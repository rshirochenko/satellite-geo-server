...
var Layers = {
    ...
    mapBox: {
        ...
        attrib: 'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors'
    }
};
...
var weightedOverlay = (function() {
    ...
    update = function() {
        ...
        $.ajax({
            ...
            data: { 'layers' : "DevelopedLand,FarmlandOrForestedLandsWithPrimeAgriculturalSoils", 
                    'weights' : "1,2",
                    'numBreaks': numBreaks},
            dataType: "json",
            success: function(r) {
                ...
                WOLayer = new L.TileLayer.WMS(server + "gt/wo", {
                    ...
                    transparent: false,
                    layers: "DevelopedLand,FarmlandOrForestedLandsWithPrimeAgriculturalSoils",
                    weights: "1,2",
    ...
    return {
        ...
        //     opacity = 1.0;
        //     //opacitySlider.slider('value', 1.0);
        //     WOLayer.setOpacity(opacity)
        //},
        ...
        if(polygon != null) {
            ...
            $.ajax({        
                ...
                success : function(data) {
                    ...
                    sdata.append($('<tr class="warning"><td></td><td class="bold">NDVI Score:</td>' + 
